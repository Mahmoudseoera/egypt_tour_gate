...
const GTM_ID = process.env.NEXT_PUBLIC_GTM_ID || "GTM-TX9R5W9";
const GA_ID = process.env.NEXT_PUBLIC_GA_ID || "G-XTGLTNNNET";
const CLARITY_ID = process.env.NEXT_PUBLIC_CLARITY_ID || "uw71zxz7uu";
