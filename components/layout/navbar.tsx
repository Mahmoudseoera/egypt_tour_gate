                    ...
                    <div className="mx-auto flex max-w-[1400px] items-center justify-between px-6 py-2 text-sm text-white">
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div className="relative group flex items-center gap-1 cursor-pointer">
                                {/* Selected language */}
                                <Image src="https://flagcdn.com/w40/us.png" alt="ENG"
                                    width={16}
                                    height={16}
                                    className="rounded-full"/>
                                <span>ENG</span>
                                <ChevronDown className="h-4 w-4 transition-transform duration-200 group-hover:rotate-180"/> {/* Dropdown */}
                                <div className="lang-menu">
                                    <Link href="/" className="lang-item">
                                        <Image src="https://flagcdn.com/w40/us.png" alt="English"
                                            width={20}
                                            height={20}
                                            className="lang-flag"/>
                                        English
                                    ...
                                    <Link href="/" className="lang-item">
                                        <Image src="https://flagcdn.com/w40/fr.png" alt="Français"
                                            width={20}
                                            height={20}
                                            className="lang-flag"/>
                                        Français
                                    ...
                                    <Link href="/" className="lang-item">
                                        <Image src="https://flagcdn.com/w40/de.png" alt="Deutsch"
                                            width={20}
                                            height={20}
                                            className="lang-flag"/>
                                        Deutsch
                                    ...
                                    <Link href="/" className="lang-item">
                                        <Image src="https://flagcdn.com/w40/eg.png" alt="Arabic"
                                            width={20}
                                            height={20}
                                            className="lang-flag"/>
                                        العربية
      ...
      `
                    ...
                    <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                        ...
                        <div className="flex md:order-2 space-x-3 rtl:space-x-reverse">
                            ...
                            <button type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-body rounded-base md:hidden hover:bg-neutral-secondary-soft">
                        ...
                        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
                            <ul className="flex flex-col md:flex-row md:space-x-8 font-medium navbar-main">
                                ...
                                <li>
                                    <Link href="/" className="block py-1 px-3  hover:text-[var(--main-color)] duration-300 ease-in">
                                        Home
                                    </Link>
                                </li>
            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
                    <ul className="flex flex-col md:flex-row md:space-x-8 font-medium">
                        {
                        data && data.header.headerCategories.map((category) => (
                            <li key={
                                    category.id
                                }
                        ...
                        <li>
                            <Link href="/contact" className="block px-4 py-2 text-sm text-heading hover:bg-neutral-tertiary">
                                Contact Us
                            </Link>
                        </li>
                    </ul>
