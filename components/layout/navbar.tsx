            ...
            <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
              <ul className="flex flex-col md:flex-row md:space-x-8 font-medium navbar-main">
                ...
                <li className="relative group has-dropdown">
                  <Link
                    href="/tours"
                    className="relative py-1 pb-2 px-3 cursor-default flex items-center hover:text-[var(--main-color)] duration-300 ease-in"
                  >
                    Egypt Tours
                    <ChevronDown size={16} />
                  </Link>
                  <ul className="absolute left-0 top-full hidden group-hover:block bg-white shadow-lg rounded-base min-w-[200px] rounded-md">
                    <li>
                      <Link
                        href="/tours"
                        className="block px-4 py-2 text-sm hover:text-[var(--main-color)] duration-300 ease-in"
                      >
                        Classic Tours
                      </Link>
                    </li>
