...
export default function ScrollToTop() {
  ...
  return (
    <button
      ...
      className={`
        fixed bottom-20 lg:bottom-8 cursor-pointer
          right-8 z-[9999]
    ...
    >
      {/* Arrow */}
      <span className="absolute inset-0 flex items-center text-[30px] justify-center text-primary">
      <svg className="arrow" width="22" height="25" fill="#e3b75e" viewBox="0 0 24 23" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Progress Circle */}
      <svg className="w-full h-full rotate-[-90deg] text-[var(--main-color)]" viewBox="-1 -1 102 102">
        <path
          ref={pathRef}
