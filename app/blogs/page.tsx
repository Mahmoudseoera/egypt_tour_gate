import { blogCategories } from "@/lib/api/blogData";
...
export default function BlogsPage() {
  return (
    <section className="blogs-page py-16 md:py-24 relative overflow-hidden bg-[#f9f9f9]">
      {/* Decorative Background Elements - Travel themed decorations */}
      <div className="absolute inset-0 pointer-events-none opacity-30">
        ...
        {/* Dotted Path SVG - simulates travel route */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          {/* Decorative Top Bar - Brand color accent */}
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            Explore our comprehensive guides and articles about traveling in Egypt. 
            From luxury experiences to budget-friendly adventures, find everything you need 
            to plan your perfect Egyptian journey.
          </p>
        </div>

        {/* Blog Categories Grid - Responsive grid layout */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-6">
          {blogCategories.map((category) => (
            ...
            >
              {/* Category Image with Link - Next.js optimized Image */}
              <Link href={`/blogs/${category.slug}`} className="block relative overflow-hidden">
                <div className="relative h-64 w-full overflow-hidden">
                  ...
                  />
                  {/* Overlay on Hover - Adds dark gradient for better text readability */}
              ...
              <div className="p-6 pb-8">
                {/* Category Title with Link - Fixed height for consistent layout */}
                ...
                {/* Category Description - Fixed height with line clamp */}
                <p className="text-gray-600 mb-6 leading-relaxed line-clamp-3 h-20">
                  {category.description}
                </p>

                {/* CTA Button with Link - Brand colored button */}
                <Link href={`/blogs/${category.slug}`}>
