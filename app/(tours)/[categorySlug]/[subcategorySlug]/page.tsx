...
export default async function SubcategoryPage({ params }: SubcategoryPageProps) {
  ...
  if (!category || !subcategory) {
    return (
      <div className="container py-10">
        ...
        <Link href="/" className="text-[var(--main-color)] underline mt-4 inline-block">
          Back to home
        </Link>
      </div>
    );
  ...
  type ListItem = (Tour | TourPackage | NileCruise) & { slug: string; title: string; price_from: number };
          ...
          {items.map((item) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                {"short_description" in item && (item as Tour).short_description && (
