...
export default function TourDetailsPage() {
  ...
  // Sample data
  const tourImages = [
    '/images/tour/main.jpg',
    '/images/tour/gallery1.jpg',
    '/images/tour/gallery2.jpg',
    '/images/tour/gallery3.jpg',
    '/images/tour/gallery4.jpg',
    '/images/tour/gallery5.jpg'
  ];
  ...
  const relatedArticles: Article[] = [
    {
      ...
      image: '/images/articles/luxury-tourism.jpg'
    },
    {
      id: '2',
      title: 'Covid-rules for traveling from USA to Egypt',
      image: '/images/articles/covid-rules.jpg'
    },
    {
      id: '3',
      title: 'Luxor Temple',
      image: '/images/articles/luxor-temple.jpg'
    }
  ];
      ...
      <section className="relative w-full h-[400px] md:h-[600px] overflow-hidden">
        <div className="grid grid-cols-4 grid-rows-2 gap-1 h-full md:gap-2">
          ...
          {[1, 2, 3, 4].map((index) => (
            <div
              key={index}
              className="relative cursor-pointer group overflow-hidden hidden md:block"
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-lg p-6 md:p-8 shadow-sm">
              ...
              <div className="space-y-6">
                {itinerary.map((day) => (
                  <div key={day.day} className="border-l-4 border-gold pl-6 pb-6 last:pb-0">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="divide-y divide-gray-200">
                {relatedArticles.map((article) => (
                  ...
                  >
                    <div className="w-20 h-20 flex-shrink-0 rounded-lg overflow-hidden bg-gradient-to-br from-amber-200 to-amber-400" />
                    <h4 className="text-sm font-semibold text-navy group-hover:text-gold transition-colors flex-1">
                      {article.title}
                    </h4>
                  </a>
                ))}
