    ...
    <div className="min-h-screen bg-main-grey">
      ...
      <section className="relative w-full h-[400px] md:h-[600px] overflow-hidden">
        <div className="grid grid-cols-4 grid-rows-2 gap-1 h-full md:gap-2">
          {/* Main large image */}
          <div 
            className="col-span-4 md:col-span-2 row-span-2 relative cursor-pointer group overflow-hidden bg-no-repeat bg-cover"
        ...
        {[1, 2, 3, 4].map((imageIndex) => (
          <div
            key={imageIndex}
            className="relative cursor-pointer group overflow-hidden hidden md:block w-full h-full bg-center bg-cover bg-no-repeat"
            style={{
