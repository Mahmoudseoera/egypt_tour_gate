    ...
    <section className="sub-category max-w-7xl mx-auto py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {(category.children ?? []).map((child: any) => (
          ...
          //   {child.name.en}
          // </Link>
          <div key={child.id} className="group relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer">
            <Link  href={`/${category.slug}/${child.slug}`}>
              ...
              <div className="p-6">
                ...
                >
                  ...
                  adipisci sint nulla alias numquam.
                </p>
